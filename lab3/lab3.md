...
* Для любых двух слов $xy, xz∈L$ с общим длинным префиксом $x$ существует синхронная накачка такая что $α_1​α_2^i​α_3​$$y⟺$$α_1​α_2^i​α_3$​$z∈L$
* Существует разбиение $x=x_1x_2x_3$, $y=y_1y_2y_3$, $z=z_1z_2z_3$ такое что $|x_2x_3|<=p$, $|x_2|>0$ и $x_1x_2^ix_3y_1y_2^iy_3∈L$ $&$ $x_1x_2^ix_3z_1z_2^iz_3∈L$
